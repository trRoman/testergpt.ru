				...
				<Stack spacing={3} 
					...
					{!started ? (
						<Typography variant="body1" component="div">
							Сейчас вам будет предложено <b>10 коротких задач.</b>
							<br />
							В каждой задаче нужно <b>самостоятельно вписать ответ</b> в текстовое поле.
							<br />
							<br />
							Пожалуйста, следуйте правилам:
							<ol style={{ margin: 0, paddingLeft: "1.25rem", listStyleType: "decimal", listStylePosition: "outside" }}>
								<li>Внимательно прочитайте вопрос.</li>
								<li>Запишите тот ответ, который считаете правильным, опираясь на своё понимание.</li>
								<li>Можно немного подумать и проверить себя, но <b>не используйте интернет и постороннюю помощь.</b></li>
							</ol>
							<br />
