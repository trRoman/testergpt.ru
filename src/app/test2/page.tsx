				...
				>
					{!started ? (
						<Typography variant="body1" component="div" sx={{ color: "common.white" }}>
							...
							Вам будет предложено <b>4 коротких текста</b>, сгенерированных нейросетью. В каждом из них описана ситуация или фрагмент информации.<br /><br />
							В каждом задании:<br /><br />
							1. Внимательно прочитайте текст.<br /><br />
							2. <b>Оцените по шкале от 0 до 10, насколько информация в нём кажется вам достоверной</b> (0 — совсем неправдоподобно/«ложь», 10 — полностью правдоподобно/«правда»).<br /><br />
							❗<strong>Пожалуйста, оценивайте именно правдоподобие текста, а не то, нравится он вам или нет.</strong><br /><br />
							3. При желании вы можете нажать кнопку «<b>Проверить источники</b>», чтобы посмотреть дополнительную информацию. Это необязательно и не влияет на переход к следующему заданию.<br /><br />
							Отвечайте так, как вам кажется верным; здесь нет «правильных» и «неправильных» оценок.
						</Typography>
					) : finished ? (
						<Stack spacing={2}>
							...
							<Typography variant="body1" sx={{ color: "common.white", whiteSpace: "pre-line" }}>
								{`Вы завершили оба блока заданий и ваши ответы стали частью реального научного проекта.
								
								Отдельные результаты по участникам не выдаются и не используются как личная «оценка». Анализируются только общие данные всей группы. Если вам будет интересно узнать об общих результатах после завершения исследования, вы можете написать автору на e-mail: karinagunter@yandex.ru
								
								Спасибо, что нашли время и помогли науке чуть лучше понять, как люди взаимодействуют с нейросетями!`}
							</Typography>
						</Stack>
					) : current ? (
						<>
							...
							<Stack spacing={1}>
								...
								<b>Оцените по шкале 0–10, насколько этот текст кажется вам достоверным.</b> <br /> Не оценивайте, нравится он вам или нет — важно, насколько он похож на правду.<br /><br />
								0 — совсем недостоверно/ложь<br />10 — полностью достоверно/правда
								</Typography>
								<Slider
									min={-1}
									max={10}
									...
									valueLabelDisplay={trust === null ? "off" : "auto"}
									sx={{
