				...
				>
					{!started ? (
						<Typography variant="body1" component="div" sx={{ color: "common.white" }}>
							...
							2. Оцените по шкале от 0 до 10, насколько вы доверяете этому ответу и ориентировались бы на него в реальной жизни (0 — совсем не доверяю, 10 — полностью доверяю).<br /><br />
